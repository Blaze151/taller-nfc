...
(function () {
    ...
    return `
      <div class="card" style="box-shadow: var(--neu-out), 0 0 0 1px rgba(111,190,68,0.35);">
        ...
        <div class="grid-2" style="margin-top:14px;">
          ...
          ${formatCosto(activo.costo) ? `<div class="field"><div class="field-label">Costo</div><div class="field-value">${esc(formatCosto(activo.costo))}</div></div>` : ""}
  ...
  async function init() {
    ...
    try {
      ...
      footerEl.textContent = taller.nombre ? `${taller.nombre} · Ficha digital de servicio · v${APP_VERSION}` : `v${APP_VERSION}`;
