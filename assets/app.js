...
(function () {
  ...
  function renderOrdenPendienteBanner(activo, v, taller) {
    ...
    const hayContenido = activo.tipo || inv.gasolina || faltantes.length || inv.danos_notas;
    ...
    return `
      <div class="orden-pendiente-banner">
        ...
        ${inv.gasolina ? `<div class="field"><div class="field-label">${esc(t("orden_gasolina_label"))}</div><div class="field-value">${esc(t(GAS_KEYS[inv.gasolina] || inv.gasolina))}</div></div>` : ""}
