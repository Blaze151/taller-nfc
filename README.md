...
Cada vehículo tiene un estado que avanza en 4 pasos:

**Recién llegado → En proceso → Listo para recoger → Finalizado**

- En la **ficha pública del cliente** se muestra como una barra de progreso
  (stepper) con la fecha de la última actualización, justo arriba de los
  datos del vehículo.
- En el **panel de administración** se puede cambiar desde el formulario de
  edición de cada vehículo, o de forma rápida desde el **Tablero** (botón
  "📋 Ver tablero por estado" en el dashboard), que agrupa todos los
  vehículos en 4 columnas según su estado actual — ideal para ver de un
  vistazo qué acaba de llegar, qué se está trabajando, qué está listo para
  recoger y qué ya se finalizó.
