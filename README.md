...
- El **costo** del servicio se oculta en la ficha del cliente mientras el servicio está en la etapa "En proceso". Se muestra de nuevo en "Listo para recoger", "Entregado" o en el historial.
...
- **Pagos**: el segmento "A deber" se muestra en amarillo para que resalte con más contraste frente a los verdes de "Pagado".
