...
**Importante:** el token solo se guarda en la memoria del navegador
(`sessionStorage`) mientras la pestaña está abierta — se borra al cerrarla.
No compartas la URL del panel ni el token fuera del taller.
