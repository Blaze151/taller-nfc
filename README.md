...
## 9. Costo, pago y aviso por WhatsApp

- El **costo** del servicio se oculta en la ficha del cliente mientras el servicio está en la etapa "En proceso" (no se ha confirmado el precio final). Se muestra de nuevo en cuanto pasa a "Listo para recoger" o queda finalizado.
- Nuevo control de **pago**, independiente de la etapa del servicio: estado (No pagado / Pagado / A deber) y método (Efectivo / Transferencia), con su propia sección de fotos y documentos (ej. comprobante de transferencia). Se conserva al pasar al historial.
- Cuando el servicio está en la etapa **"Listo para recoger"**, el admin ve dos opciones: "🚗 Aún no lo recoge" o "✅ Ya lo recogió — Finalizar" (esta última mueve el servicio al historial, igual que antes).
- Al cambiar la etapa a **"Listo para recoger"** (desde el editor o desde el Tablero), el sistema pregunta si quieres enviar un mensaje de WhatsApp al cliente. Si aceptas, abre WhatsApp con un mensaje ya redactado: saluda al cliente por su nombre, menciona el vehículo (marca/modelo/placas) y el monto a pagar. Requiere que el vehículo tenga un teléfono de cliente registrado (números mexicanos de 10 dígitos se completan automáticamente con el código de país 52).
