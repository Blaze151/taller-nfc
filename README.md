...
- **Listo para recoger**: muestra qué porcentaje del total de servicios activos está en esa fase (listo + recogido combinados), y ese mismo porcentaje se divide en dos colores — cuántos ya fueron recogidos y cuántos aún no — dejando el resto de las etapas en gris. Por ejemplo, si el 67% de los servicios activos están en fase de recoger, se ve dividido en "33% ya recogido" y "33% aún no lo recogen".
- **Pagos**: mismo patrón — el porcentaje que representa "pagado + a deber" se divide en dos verdes (pagado vs a deber), dejando "no pagado" en gris.
...
- En el panel de administración, las secciones **"Datos del vehículo"** y **"Ficha técnica"** ahora son desplegables (tócalas para expandir/colapsar), y las fotos/documentos de cada etapa del servicio en proceso también se muestran colapsadas con su conteo, para que el editor no se sienta tan largo.
