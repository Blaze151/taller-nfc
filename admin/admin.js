      ...
      <div class="vlist-item" data-id="${v.id}" style="display:block;">
        <div style="display:flex;gap:10px;align-items:center;">
          ...
          <div style="flex:1;min-width:0;">
            ...
            <div class="vlist-item-sub">ID: ${v.id} ${v.numero_unidad ? "· " + esc(t("unidad_prefix")) + " " + esc(v.numero_unidad) : ""} ${v.cliente_nombre ? "· " + v.cliente_nombre : ""} · ${(v.servicios || []).length} ${esc(t("en_historial"))}</div>
          </div>
        </div>
