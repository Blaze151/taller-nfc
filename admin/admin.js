...
(function () {
  ...
  function renderDashboard(filter) {
    ...
    // Del más reciente al más antiguo. Los vehículos nuevos ya guardan su
    // fecha de creación; los que ya existían de antes no la tienen, así que
    // para esos se respeta el orden en que aparecen en el archivo (los
    // agregados más tarde van primero entre ellos).
  ...
  $("view-editor").addEventListener("click", (e) => {
    if (e.target.closest("button") || e.target.closest(".fuel-track")) hasUnsavedChanges = true;
  });
