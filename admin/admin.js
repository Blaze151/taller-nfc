  ...
  function renderBoard() {
    ...
    cards.push(renderPieCard({
      ...
      segments: [
        ...
        { label: "Aún no lo recogen", value: porEtapa.listo.length, color: GREEN },
    ...
    cards.push(renderPieCard({
      ...
      segments: [
        ...
        { label: "A deber", value: aDeber.length, color: GREEN },
        { label: "No pagado", value: noPagados.length, color: GRIS },
      ],
      holdPct: totalActivos ? Math.round(((pagados.length + aDeber.length) / totalActivos) * 100) : 0,
      vehiculos: activos,
