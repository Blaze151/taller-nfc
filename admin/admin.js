...
(function () {
  ...
  let lightboxEl, lightboxImg, lightboxCounter, lightboxPhotos = [], lightboxIndex = 0, lightboxOpenedAt = 0;
  ...
  function initLightbox() {
    ...
    lightboxEl.addEventListener("click", (e) => {
      if (e.target === lightboxEl && Date.now() - lightboxOpenedAt > 400) closeLightbox();
    });
  ...
  function renderOrdenRecepcionSection() {
    ...
    return `
      <div style="margin-top:18px;padding-top:14px;border-top:1px solid rgba(255,255,255,0.06);">
        <div class="card-title" style="font-size:12px;">${esc(t("orden_recepcion_titulo"))}</div>
