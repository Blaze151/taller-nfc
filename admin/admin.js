...
(function () {
  ...
  function renderStageBlock(stage, infoOverride) {
    ...
    const toolKey = stage === "recibido" ? "recibido" : (stage === "en_proceso" ? "en_proceso" : null);
    ...
    } else if (stage === "en_proceso") {
      toolButtonHtml = `<button type="button" class="btn btn-sm ${toolIsOpen ? "btn-tool-active" : "btn-outline"}" data-toggle-tool="en_proceso">${esc(t("cotizacion_titulo"))}</button>`;
